...
def publish_random_energy():
    ...
    while True:
        ...
        if(probability<PROB):
           ...
           command = f'ros2 topic pub /turtle2/energy std_msgs/Int32 "{\'data\':' + str(energy_turtle1) + '}"'
        ...
        if(probability<PROB):
           ...
           # Montar o comando a ser executado
           command = f'ros2 topic pub /turtle2/energy std_msgs/Int32 "{\'data\':' + str(energy_turtle2) + '}"'
